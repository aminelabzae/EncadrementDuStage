...
@section('content')
<div class="header-title" style="margin-bottom: 2rem;">Ajouter un Stagiaire</div>
    ...
    <form action="{{ route('stagiaires.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
            ...
            <div style="grid-column: span 2;">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required style="width: 100%; background: #f0f6ff; border: 1px solid var(--border); color: var(--text-main); padding: 0.75rem; border-radius: 8px; outline: none;" placeholder="stagiaire@ecole.com">
            ...
            <div style="grid-column: span 2;">
                ...
                <input type="text" name="ecole" value="{{ old('ecole') }}" required style="width: 100%; background: #f0f6ff; border: 1px solid var(--border); color: var(--text-main); padding: 0.75rem; border-radius: 8px; outline: none;" placeholder="Nom de l'établissement">
            ...
            <div>
                ...
                <input type="text" name="filiere" value="{{ old('filiere') }}" required style="width: 100%; background: #f0f6ff; border: 1px solid var(--border); color: var(--text-main); padding: 0.75rem; border-radius: 8px; outline: none;" placeholder="Ex: Génie Logiciel">
            ...
            <div>
                ...
                <select name="niveau" required style="width: 100%; background: #f0f6ff; border: 1px solid var(--border); color: var(--text-main); padding: 0.75rem; border-radius: 8px; outline: none;">
                    ...
                    <option value="1ere année" {{ old('niveau') == '1ere année' ? 'selected' : '' }}>1ère année</option>
                    <option value="2eme année" {{ old('niveau') == '2eme année' ? 'selected' : '' }}>2ème année</option>
                    <option value="3eme année" {{ old('niveau') == '3eme année' ? 'selected' : '' }}>3ème année</option>
